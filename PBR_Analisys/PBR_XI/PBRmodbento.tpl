...
//vector de mortalidad por pesca a evaluar
  ...
  // se estima la sobrevivencia por edad y año
     for (int i=2;i<=nedades;i++){ // ciclo de años
     N(i)=N(i-1)*exp(-Z(i-1));
     }
  ...
  report << "-----------------------------------------------------------------------------" << endl;
  report << "h = " <<" "<<h<< endl;
  report << "SSBPRo = " <<" "<<Bo<< endl;
  report << "-----------------------------------------------------------------------------" << endl;
  report << "Fmsy    MSY/R   SSBmsy/R    SSBmsy/SSBo" << endl;
  report << "-----------------------------------------------------------------------------" << endl;
 ...
 report << " " << endl;
  ...
  report << "-----------------------------------------------------------------------------" << endl;
  report << "  Fo1 ="<<" "<<F01<<"  (numerical approximation)"<<endl;
  report << " " << endl;

  report << "-----------------------------------------------------------------------------" << endl;
  report << "Fcr    YPR  SSBPR   SSBeq   Req   SSBeq/SSBo   Yeq" << endl;
  report << "-----------------------------------------------------------------------------" << endl;
   while(aux==1){
