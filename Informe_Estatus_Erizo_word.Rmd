...
```{r datInd2, warning=F, include=T, message=F, echo=FALSE,fig.height=6,fig.width=5,fig.align="center",fig.path=dir.Fig,dev=fig, fig.cap="CPUE de entrada al modelo de evaluación de stock para las tres unidades de stock de erizo"}
...
```{r Fig_ajustesCompFXN,warning=F, include=T, message=F, echo=FALSE,fig.height=8,fig.width=8,fig.align="center",fig.path=dir.Fig,dev=fig, fig.cap="**Figura x**. Ajustes de la proporción de tallas de erizo de la zona XN"}
age  <-rep1$Tallas                                          
nage<-length(age)   
